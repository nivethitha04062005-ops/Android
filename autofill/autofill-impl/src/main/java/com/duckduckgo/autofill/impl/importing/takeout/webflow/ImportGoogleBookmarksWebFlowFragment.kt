...
class ImportGoogleBookmarksWebFlowFragment :
    ...
    interface WebViewVisibilityListener {
        fun onWebViewVisibilityChange(shouldShowWebView: Boolean)
    }
    ...
    private fun notifyWebViewVisibilityChanged(shouldShowWebView: Boolean) {
        (activity as? WebViewVisibilityListener)?.onWebViewVisibilityChange(shouldShowWebView)
    }
